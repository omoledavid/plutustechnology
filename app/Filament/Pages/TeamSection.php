...
class TeamSection extends Page implements HasForms
{
    use InteractsWithForms;
    protected static ?string $navigationIcon = 'heroicon-o-document-text';

    protected static string $view = 'filament.pages.team-section';
    protected static ?string $navigationGroup = 'Sections';
    public ?array $data = [];

    public function mount(): void
    {
        $settings = PageSection::where('section_key', 'team')->first();
    ...
    protected function getFormSchema(): array
    {
        return [
            Forms\Components\Grid::make(2)
                ->schema([
                    FormSection::make('Team Section Content')
                        ->columns(2)
                        ->schema([
